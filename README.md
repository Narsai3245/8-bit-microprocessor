...
A single-cycle-per-state 8-bit microprocessor implemented in VHDL for the Digilent Nexys A7-100T FPGA board. Built for an ECE 2700 (Digital Logic) Design course project.
